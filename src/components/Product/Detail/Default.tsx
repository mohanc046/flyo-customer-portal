...
import { useRouter } from "next/router"; // Use `useRouter` to get query params
...
const ProductDetails = () => {
  ...
  const id = "671d23c51578dcdeab7e80f5";
  ...
  useEffect(() => {
    if (id) {
      const fetchedProduct = getProductByID(id as string); // Fetch product by ID
                ...
                <div className="choose-quantity flex items-center lg:justify-between gap-5 gap-y-3 mt-3">
                  <div className="quantity-block md:p-3 max-md:py-1.5 max-md:px-3 flex items-center justify-between rounded-lg border border-line sm:w-[180px] w-[120px] flex-shrink-0">
                    <Icon.Minus
                      ...
                      className={`${
                        product.quantityPurchase === 1 ? "disabled" : ""
                      } cursor-pointer`}
                    />
